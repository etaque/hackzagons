...
Elm.Constant.Color.make = function (_elm) {
   ...
   var rock = "rgb(160, 146, 159)";
   var grass = "rgb(200, 230, 180)";
   var sand = "rgb(242, 243, 196)";
   var water = "rgb(147,202,223)";
...
Elm.Main.make = function (_elm) {
   ...
   var actions = $Signal.mergeMany(_L.fromArray([A2($Signal.map,
                                                ...
                                                ,A2($Signal.map,
                                                function (b) {
                                                   return b ? $Update.NextTileKind : $Update.NoOp;
                                                },
                                                $Keyboard.space)
                                                ,A2($Signal.map,
                                                function (b) {
                                                   return b ? $Update.EscapeMode : $Update.NoOp;
                                                },
                                                $Keyboard.isDown(27))]));
...
Elm.Model.make = function (_elm) {
   ...
   var toPoint = function (_v0) {
      return function () {
         ...
         _U.badCase($moduleName,
         "on line 134, column 4 to 24");
      }();
   };
   var hexToCube = function (_v4) {
      return function () {
         switch (_v4.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple3"
                   ...
                   ,_2: 0 - _v4._0 - _v4._1};}
         _U.badCase($moduleName,
         "on line 111, column 4 to 14");
      }();
   };
   var cubeToHex = function (_v8) {
      return function () {
         switch (_v8.ctor)
         {case "_Tuple3":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: _v8._1};}
         _U.badCase($moduleName,
         "on line 107, column 4 to 8");
      }();
   };
   var cubeRound = function (_v13) {
      return function () {
         switch (_v13.ctor)
         {case "_Tuple3":
            return function () {
                 var rz = $Basics.round(_v13._2);
                 var zDiff = $Basics.abs($Basics.toFloat(rz) - _v13._2);
                 var ry = $Basics.round(_v13._1);
                 var yDiff = $Basics.abs($Basics.toFloat(ry) - _v13._1);
                 var rx = $Basics.round(_v13._0);
                 var xDiff = $Basics.abs($Basics.toFloat(rx) - _v13._0);
                 return _U.cmp(xDiff,
   ...
   var pointToHexCoords = function (_v18) {
      return function () {
         switch (_v18.ctor)
         {case "_Tuple2":
            return function () {
                 var j = _v18._1 * (2 / 3) / $Constant$Size.hexRadius;
                 var i = (_v18._0 * $Basics.sqrt(3) / 3 - _v18._1 / 3) / $Constant$Size.hexRadius;
   ...
   var hexCoordsToPoint = function (_v22) {
      return function () {
         switch (_v22.ctor)
         {case "_Tuple2":
            return function () {
                 var y = $Constant$Size.hexRadius * 3 / 2 * $Basics.toFloat(_v22._1);
                 var x = $Constant$Size.hexRadius * $Basics.sqrt(3) * ($Basics.toFloat(_v22._0) + $Basics.toFloat(_v22._1) / 2);
                 return {ctor: "_Tuple2"
                        ,_0: x
                        ,_1: y};
              }();}
   ...
   var deleteTile = F2(function (_v26,
   grid) {
      return function () {
         switch (_v26.ctor)
         {case "_Tuple2":
   ...
   var getTilesList = function (grid) {
      return function () {
         ...
         _v38) {
            return function () {
               switch (_v38.ctor)
               {case "_Tuple2": return A2(Tile,
                    _v38._1,
                    {ctor: "_Tuple2"
                    ,_0: i
                    ,_1: _v38._0});}
               _U.badCase($moduleName,
               "on line 127, column 7 to 22");
            }();
         });
         var mapRow = function (_v42) {
            return function () {
               switch (_v42.ctor)
               {case "_Tuple2":
                  return A2($List.map,
...
Elm.Update.make = function (_elm) {
         ...
         {case "CreateTile":
            switch (mode._0.ctor)
              {case "Rock":
                 return $Model.Erase;
                 case "Sand":
                 return $Model.CreateTile($Model.Rock);
                 case "Water":
                 return $Model.CreateTile($Model.Sand);}
              break;}
         return $Model.CreateTile($Model.Water);
      }();
   };
   ...
   var getMouseEventTile = F2(function (model,
   event) {
      return function () {
         ...
         return A2($Maybe.map,
         function ($) {
            return $Model.pointToHexCoords(clickPoint(model)($));
         },
         pointMaybe);
      }();
   });
   ...
   model) {
      return function () {
         ...
         model,
         event);
         var newGrid = $Maybe.withDefault(model.grid)(A2($Maybe.map,
         function (c) {
            return A3($Model.createTile,
            kind,
            c,
            model.grid);
         },
...
Elm.View.make = function (_elm) {
   ...
   var tileKindColor = function (kind) {
      return function () {
         switch (kind.ctor)
         {case "Rock":
            return $Constant$Color.rock;
            case "Sand":
            return $Constant$Color.sand;
            case "Water":
            return $Constant$Color.water;}
         _U.badCase($moduleName,
   ...
   var renderMode = function (mode) {
      return function () {
         var color = function () {
            switch (mode.ctor)
            {case "CreateTile":
               return tileKindColor(mode._0);
               case "Erase":
               return $Constant$Color.grass;
   ...
   var renderTile = function (_v3) {
      return function () {
         return function () {
            ...
            _L.fromArray([$Svg.text($Basics.toString(_v3.coords))]));
            var color = tileKindColor(_v3.kind);
            var hex = A2($Svg.polygon,
            _L.fromArray([$Svg$Attributes.points($View$Hexagon.verticesPoints)
                         ,$Svg$Attributes.fill(color)
                         ,$Svg$Attributes.stroke(color)
                         ,$Svg$Attributes.strokeWidth("1")]),
            _L.fromArray([]));
            var $ = $Model.hexCoordsToPoint(_v3.coords),
            x = $._0,
            y = $._1;
            return A2($Svg.g,
   ...
   var renderTiles = function (_v5) {
      return function () {
         return function () {
            var $ = $Model.toPoint(_v5.dims),
            w = $._0,
            h = $._1;
            var cx = w / 2 + $Basics.fst(_v5.center);
            var cy = h / 2 + $Basics.snd(_v5.center);
            var tiles = A2($List.map,
            renderTile,
            $Model.getTilesList(_v5.grid));
            return A2($Svg.g,
            _L.fromArray([$Svg$Attributes.transform(A2($Basics._op["++"],
            "translate(",
            A2($Basics._op["++"],
   ...
   var render = function (model) {
      ...
      _L.fromArray([renderTiles(model)
   ...
   var toSvgPoints = function (points) {
      return $String.join(" ")($List.map(function (_v0) {
         return function () {
            ...
            _U.badCase($moduleName,
            "on line 38, column 29 to 60");
         }();
      })(points));
   };
   var vertices = function () {
      var $ = $Constant$Size.hexDims,
      w = $._0,
      h = $._1;
      var w2 = w / 2;
      var h2 = h / 2;
